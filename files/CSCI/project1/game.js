...
function onKeyDown(evt){
    if(evt.keyCode == 68) {pacman.dx=velocity; pacman.x+=1; pacman.dy=0; pacman.direction= 3;}//Right key
    else if(evt.keyCode ==83) {pacman.dy=velocity; pacman.y+=1; pacman.dx=0; pacman.direction = 0;} //down key
    else if(evt.keyCode == 87) {pacman.dy=-velocity; pacman.y-=1; pacman.dx=0; pacman.direction = 2;}//up key
    else if(evt.keyCode == 65) {pacman.dx=-velocity; pacman.x-=1; pacman.dy=0; pacman.direction = 1;}//Left Key
