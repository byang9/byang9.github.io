...
window.onload = function() {updateSong();}
...
function updateSong(){
    ...
    document.getElementById('element').onclick = function() {
        function generate() {
            ...
            return input.replace(/(?:https:\/\/)?(?:www\.)?(?:youtube\.com|youtu\.be)\/(?:watch\?v=)?(.+)/g, '<iframe width="850" height="500" src="http://www.youtube.com/embed/$1" frameborder="0" allowfullscreen></iframe>');
        }
...
var musicNum, urlName;
function song(musicfile,url){
    var input = url;
    musicNum = musicfile; urlName = url;
    //document.getElementById('video').innerHTML = input.replace(/(?:https:\/\/)?(?:www\.)?(?:youtube\.com|youtu\.be)\/(?:watch\?v=)?(.+)/g, '<iframe width="850" height="500" src="http://www.youtube.com/embed/$1" frameborder="0" allowfullscreen></iframe>');
    ...
    /*document.getElementById('video').onload = function(){
        if(musicfile == '1'){
            ...
            document.getElementById('audio1').style.display = 'inline';
            ...
            document.getElementById('audio2').style.display = 'inline';
            document.getElementById('audio3').style.display = 'none';
        }else if(musicfile == '3'){
